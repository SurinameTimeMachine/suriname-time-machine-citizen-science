import type { MediaAsset, NavLink, ResourceItem, Stat } from '../components';
...
export const section01HeroContent = {
  highlights: [
...
export const section02IntroContent = {
  paragraphs: [
...
export const section03CaseStudyContent = {
  paragraphs: [
...
export const section04MethodologyContent = {
  missionParagraphs: [
...
export const section05PartnersContent = {
  partners: [
...
export const section06ContactContent = {
...
export const homePageSections = [
  {
    ...
    description: 'Top-level navigation bar with anchor links.',
    contentRefs: ['navLinks'],
  },
  {
    id: 'hero',
    component: 'Section01Hero',
    anchor: '#overview',
    description: 'Hero overview with highlights, stats, and background map.',
    contentRefs: [
      'section01HeroContent.highlights',
      'section01HeroContent.stats',
    ],
    mediaRefs: ['section01HeroContent.background'],
  },
  {
    id: 'intro',
    component: 'Section02Intro',
    anchor: '#story',
    description:
      'Narrative about the Ellis–de Hart family and research context.',
    contentRefs: [
      'section02IntroContent.paragraphs',
      'section02IntroContent.source',
    ],
    mediaRefs: ['section02IntroContent.portrait'],
    nested: [
      {
        component: 'ApplicationsList',
        description:
          'Highlights archival resources made available on the platform.',
        contentRefs: ['section02IntroContent.resources'],
        mediaRefs: ['section02IntroContent.resources'],
      },
    ],
  },
  {
    id: 'case-study',
    component: 'Section03CaseStudy',
    anchor: '#case-study',
    description: 'Case study detailing Sardam plantation and its inhabitants.',
    contentRefs: [
      'section03CaseStudyContent.paragraphs',
      'section03CaseStudyContent.captions',
      'section03CaseStudyContent.source',
    ],
    mediaRefs: ['section03CaseStudyContent.plantationAsset'],
  },
  {
    id: 'methodology',
    component: 'Section04Methodology',
    anchor: '#methodology',
    description: 'Explains project mission, map work, and research team.',
    contentRefs: [
      'section04MethodologyContent.missionParagraphs',
      'section04MethodologyContent.mapParagraphs',
      'section04MethodologyContent.teamParagraphs',
      'section04MethodologyContent.employees',
      'section04MethodologyContent.infrastructureParagraph',
    ],
    mediaRefs: ['section04MethodologyContent.mapAsset'],
  },
  {
    id: 'partners',
    component: 'Section05Partners',
    anchor: '#partners',
    description: 'List of institutional partners and supporters.',
    contentRefs: ['section05PartnersContent.partners'],
    mediaRefs: ['section05PartnersContent.mapAsset'],
  },
  {
    id: 'contact',
    component: 'Section06Contact',
    anchor: '#contact',
    description: 'Contact information for the project team.',
    contentRefs: ['section06ContactContent'],
  },
  {
    id: 'footer',
    component: 'SiteFooter',
    description: 'Footer lockup for SCiTMI.',
    contentRefs: ['SiteFooter.organizationLabel'],
  },
